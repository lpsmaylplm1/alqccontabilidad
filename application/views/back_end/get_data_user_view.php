                ...
                <form class="form-horizontal form-label-left input_mask" name="load_edit_user" id="load_edit_user" action="" method="">
					<?php foreach ($prev_data_user as $load_data_user): ?>
						...
						<div class="col-md-4 col-sm-6 col-xs-12 form-group has-feedback">
							...
							<input type="text" class="form-control has-feedback-left" id="nombre_usr" name="nombre_user" value="<?php echo ($load_data_user->nombre_user) ?>" readonly="true" >
							<span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
						</div>
						<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
							<label for="ap_p_user">Apellido Paterno</label>
							<input type="text" class="form-control has-feedback-left" id="ap_p_user" name="ap_p_user" value="<?php echo ($load_data_user->ap_p_user) ?>"  readonly="true">
							<span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
						</div>
						<div class="col-md-3 col-sm-6 col-xs-12 form-group has-feedback">
							<label for="app_m_user">Apellido Materno</label>
							<input type="text" class="form-control has-feedback-left" id="app_m_user" name="app_m_user" value="<?php echo ($load_data_user->app_m_user) ?>"  readonly="true">
							<span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
							<label for="correo_user">Correo Electrónico</label>
							<input type="email" class="form-control has-feedback-left" id="correo_user" name="correo_user" value="<?php echo ($load_data_user->correo_user) ?>" readonly="true" >
							<span class="fa fa-envelope form-control-feedback left" aria-hidden="true"></span>
						</div>
					<div class="col-md-4 col-sm-6 col-xs-12 form-group has-feedback">
							<label for="tipo_usuario">Tipo  de usuario</label>
							<select class="form-control" name="tipo_usuario" id="tipo_usuario" disabled="TRUE">
						...
						<div class="col-md-4 col-sm-6 col-xs-12 form-group has-feedback">
							...
							<input type="text" class="form-control has-feedback-left" id="usuario" name="usuario" value="<?php echo ($load_data_user->usuario) ?>" readonly="true" >
							<span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
						</div>
						<div class="col-md-4 col-sm-6 col-xs-12 form-group has-feedback">
							<label for="password1">CONTRASEÑA</label>
							<input type="password" class="form-control has-feedback-left" id="password1" name="password1" value="<?php echo $pass ?>" readonly="true" >
						...
						<div class="form-check col-md-4 col-sm-9 col-xs-12" style="vertical-align: middle">
							...
							?>   
								   id="activo" name="activo" value="1" readonly="true"> 
