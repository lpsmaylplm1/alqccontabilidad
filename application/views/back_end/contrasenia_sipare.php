...
<div class="row">
	<div class="col-md-12 col-xs-12">
		<div class="col-md-12 col-sm-6 col-xs-12 ">
			<form class="form-horizontal form-label-left input_mask" name="add_pass_sipare" id="add_pass_sipare" method="POST">
				...
				<div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
					<label for="usuario_sipare">USUARIO SIPARE</label>
					<input type="text" class="form-control has-feedback-left" id="usuario_sipare" name="usuario_sipare" placeholder="Usuario">
					<span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
				</div>
				<div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
					<label for="contrasenia_sipare">CONTRASEÑA</label>
					<input type="text" class="form-control has-feedback-left" id="contrasenia_sipare" name="contrasenia_sipare" placeholder="Contraseña">
	...
	<script type="text/javascript">
		$('#save_form_register_pass').click(function () {
			...
			URL = base_url + "clientes/agregar_pass_sipare";
			$.ajax({
				type: "POST",
				url: URL,
				data: $("#add_pass_sipare").serialize(),
				dataType: "html",
				beforeSend: function () {
