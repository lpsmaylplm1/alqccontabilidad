...
class usuarionologueado {
	...
	Public function __construct() {
		...
		$this->allowed_controllers = ['home', 'login']; //Acceso a Controlador Consultas, Home a usuarios no autenticados
		$this->allowed_methods = ['login', '']; //Permitir acceso al método Login
		$this->disallowed_methods = ['logout']; //No autenticado no tiene acceso a Método LogOut
